...
saveTrafficSignalConfigRules = [
  ...
  body("signal1Time")
    ...
    .isInt({ min: 1 })
    .withMessage("signal1Time must be a positive integer"),

  body("signal2Time")
    .notEmpty()
    .withMessage("signal2Time is required")
    .isInt({ min: 1 })
    .withMessage("signal2Time must be a positive integer"),

  body("signal3Time")
    .notEmpty()
    .withMessage("signal3Time is required")
    .isInt({ min: 1 })
    .withMessage("signal3Time must be a positive integer"),
  ...
  body("signal4Time")
    ...
    .isInt({ min: 1 })
    .withMessage("signal4Time must be a positive integer"),
  ...
  body("signal5Time")
    ...
    .isInt({ min: 1 })
    .withMessage("signal5Time must be a positive integer"),
];
